...
const SECTIONS = [
	{
		title: "Women",
		labels: ["Abayas", "Dresses", "Tops", "Sets"],
	},
	{
		title: "Kids",
		labels: ["Girls", "Boys", "Babies", "New"],
	},
	{
		title: "Collections",
		labels: ["Eid", "Bridal", "Summer", "Sale"],
	},
] as const;

const CYCLE_MS = 3500;
const BRAND_BURGUNDY = "#8B2C3F";

export function AiyifenPreview() {
				...
				<AnimatePresence mode="wait">
					...
					>
						<div className="flex items-center justify-between">
							<h4 className="text-[10px] font-bold leading-none tracking-wide">
								{section.title}
							</h4>
						...
						<div className="grid grid-cols-4 gap-1">
							{section.labels.map((label) => (
								<div
									key={label}
									className="relative aspect-[4/3] overflow-hidden rounded-md bg-gradient-to-br from-rose-100 to-rose-300"
								>
