...
const SECTIONS = [
	{
		...
		labels: ["Track", "Crystal", "Pendant", "Chandeliers"],
	},
	{
		title: "Wall Sconces",
		labels: ["Candle", "Art Deco", "Traditional", "Modern"],
	},
	{
		title: "Table Lamps",
		labels: ["Wooden", "Task", "Modern", "Antique"],
	},
] as const;
...
export function JojooshopPreview() {
					...
					>
						...
						<div className="grid grid-cols-4 gap-1">
							{section.labels.map((label) => (
								<div
									key={label}
									className="relative aspect-[4/3] overflow-hidden rounded-md bg-gradient-to-br from-neutral-700 to-neutral-900"
								>
									<span className="absolute bottom-1 left-1 text-[6px] font-bold leading-tight text-white">
										{label}
									</span>
								</div>
							))}
